...
/*   Updated: 2022/10/10 13:34:58 by wiozsert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	std::cout << "The memory address of attribut stringREF is : " << "|" << &stringREF << "|" "\033[0m" << std::endl << std::endl;
	...
	std::cout << "The value pointed by stringREF is : " << "|" << stringREF << "|" << "\033[0m" << std::endl;
